<template>
        ...
        >
          ...
          <div class="colors-selection">
            ...
            <div class="colors flex gap-3 items-center py-3">
              <label v-for="(color, colorIndex) in macbook.color" :key="colorIndex">
                <input
                  type="radio"
          ...
          <div class="title-content py-3">
            ...
            <h2 class="fs-600 font-medium leading-relaxed">
              {{ macbook.installment }}/mo. for <br />
              24 mo.*
            </h2>
            <a
            ...
            >
              ...
              <FontAwesomeIcon class="fs-100" :icon="faAngleRight" />
              <FontAwesomeIcon class="fs-300" :icon="faSquarePlus" />
            </a>
            <div class="trade-in-content fs-200 py-3">
              <p class="font-medium">Add a trade-in</p>
              <p class="font-light">
                Get credit towards a new Mac when you trade in your eligible computer. Or
                recycle it for free.<sup>**</sup>
              </p>
              <a href="" target="_blank" class="flex items-center gap-2 pt-1">
                <span>Get Started</span>
                <FontAwesomeIcon class="fs-300" :icon="faSquarePlus" />
              </a>
            </div>
            <div class="select-content py-3">
              <RouterLink to="/product" class="select-btn fs-200 font-medium"
                >Select</RouterLink
              >
            </div>
            <div class="save-content fs-200 py-3">
              ...
              <p class="font-light">
                Keep all your selections by saving this device to Your Saves, then come
                back anytime and pick up right where you left off.
              </p>
              <a
            ...
            <div class="delivery-content flex gap-3 pt-4 pb-2">
              <svg
                class="as-svgicon-rtl-mirrored as-svgicon as-svgicon-boxtruck as-svgicon-reduced as-svgicon-boxtruckreduced"
                viewBox="0 0 25 25"
                role="img"
                aria-hidden="true"
                width="25px"
  ...
  <div class="content-limit box-content py-8">
    ...
    <div class="perfect-img flex py-4 items-center fs-200 self-stretch">
      ...
      <div class="text-center h-full flex flex-col items-center" style="width: 171px">
        <div class="img-wrapper flex justify-center w-full">
          <img width="45" height="392" :src="getBoxCableSrc()" alt="cable" />
        </div>
        <span class="box-text block w-full">
    ...
    <div class="py-6">
      ...
      >
        <swiper-slide>
          <div class="text-center h-full">
            <div class="img-wrapper">
              <img :src="getBoxImgSrc()" alt="macbook" />
            </div>
            <span class="box-text block w-full">
              <span v-if="selectedSize === '14-inch'">14-inch Macbook Pro</span>
              <span v-else>16-inch Macbook Pro</span>
        ...
        <swiper-slide>
          <div class="text-center h-full">
            <div class="img-wrapper">
              <img :src="getBoxCableSrc()" alt="cable" />
            </div>
            <span class="box-text block w-full bg-white"
              >USB-C to MagSafe 3 Cable (2m)</span
            >
          </div>
        </swiper-slide>
        <swiper-slide>
